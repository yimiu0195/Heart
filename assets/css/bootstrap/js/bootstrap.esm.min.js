...
function addHandler(e, t, n, i, s) {
    ...
    const _ = getUidEvent(r, t.replace(namespaceRegex, "")),
        h = o ? bootstrapDelegationHandler(e, n, i) : bootstrapHandler(e, n);
            ...
            return (
                ...
                void 0 !== n &&
                    Object.keys(n).forEach((e) => {
                        Object.defineProperty(_, e, { get: () => n[e] });
                    }),
                E && _.preventDefault(),
                c && e.dispatchEvent(_),
...
class Alert extends BaseComponent {
    ...
    _destroyElement(e) {
        e.remove(), EventHandler.trigger(e, EVENT_CLOSED);
    }
...
class Carousel extends BaseComponent {
    ...
    _addEventListeners() {
        this._config.keyboard &&
            ...
            "hover" === this._config.pause &&
                (EventHandler.on(this._element, EVENT_MOUSEENTER, (e) =>
                    this.pause(e)
                ),
                EventHandler.on(this._element, EVENT_MOUSELEAVE, (e) =>
                    this.cycle(e)
                )),
            this._config.touch &&
                this._touchSupported &&
    ...
    _addTouchEventListeners() {
        ...
        SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach((e) => {
            ...
            this._pointerEvent
                ? (EventHandler.on(this._element, EVENT_POINTERDOWN, (t) =>
                      e(t)
                  ),
                  EventHandler.on(this._element, EVENT_POINTERUP, (e) => n(e)),
                  this._element.classList.add("pointer-event"))
                : (EventHandler.on(this._element, EVENT_TOUCHSTART, (t) =>
                      e(t)
                  ),
    ...
    _getItemByOrder(e, t) {
        ...
        return getNextActiveElement(this._items, t, n, this._config.wrap);
    }
    ...
    _setActiveIndicatorElement(e) {
        if (this._indicatorsElement) {
            const t = SelectorEngine.findOne(
                ".active",
    ...
    static carouselInterface(e, t) {
        const n = Carousel.getOrCreateInstance(e, t);
        let { _config: i } = n;
...
const NAME$9 = "collapse",
    ...
    Default$8 = { toggle: !0, parent: "" },
    DefaultType$8 = { toggle: "boolean", parent: "(string|element)" },
...
class Collapse extends BaseComponent {
    ...
    show() {
        ...
        let e, t;
        this._parent &&
            ((e = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(
                (e) =>
        ...
        if (e) {
            ...
            if (
                ((t = i ? Collapse.getInstance(i) : null),
    ...
    _getConfig(e) {
        return (
            ((e = { ...Default$8, ...e }).toggle = Boolean(e.toggle)),
            typeCheckConfig(NAME$9, e, DefaultType$8),
            e
        );
    }
    _getDimension() {
...
EventHandler.on(
    ...
    function (e) {
        ...
        SelectorEngine.find(n).forEach((e) => {
            const n = Collapse.getInstance(e);
            let i;
            n
                ? (null === n._parent &&
                      "string" == typeof t.parent &&
                      ((n._config.parent = t.parent),
...
class Dropdown extends BaseComponent {
    ...
    show() {
        if (isDisabled(this._element) || this._menu.classList.contains("show"))
            return;
    ...
    _getConfig(e) {
        if (
            ...
            typeCheckConfig(NAME$8, e, this.constructor.DefaultType),
    ...
    static dropdownInterface(e, t) {
        const n = Dropdown.getOrCreateInstance(e, t);
        if ("string" == typeof t) {
            if (void 0 === n[t]) throw new TypeError(`No method named "${t}"`);
            n[t]();
        }
    ...
    static clearMenus(e) {
        ...
        for (let n = 0, i = t.length; n < i; n++) {
            const i = Dropdown.getInstance(t[n]);
    ...
    static dataApiKeydownHandler(e) {
        ...
        return "Escape" === e.key
            ? (n().focus(), void Dropdown.clearMenus())
            : "ArrowUp" === e.key || "ArrowDown" === e.key
            ? (t || n().click(),
              void Dropdown.getInstance(n())._selectMenuItem(e))
    ...
    _getConfig(e) {
        return (
            ((e = {
                ...Default$6,
                ...("object" == typeof e ? e : {}),
            }).rootElement = getElement(e.rootElement)),
...
class Offcanvas extends BaseComponent {
    ...
    _enforceFocusOnElement(e) {
        EventHandler.off(document, EVENT_FOCUSIN$1),
            EventHandler.on(document, EVENT_FOCUSIN$1, (t) => {
                document === t.target ||
                    e === t.target ||
                    e.contains(t.target) ||
                    e.focus();
    ...
    getTipElement() {
        return (
            this.tip ||
                ...
                this._getContent() ||
                    SelectorEngine.findOne(".popover-body", this.tip).remove()),
            this.tip
        );
    }
    setContent() {
        ...
        "function" == typeof t && (t = t.call(this._element)),
            this.setElementContent(
                SelectorEngine.findOne(".popover-body", e),
                t
            ),
            e.classList.remove("fade", "show");
    }
...
class ScrollSpy extends BaseComponent {
            ...
            SelectorEngine.find(this._selector)
                .map((e) => {
                    ...
                    if (s) {
                        ...
                        if (e.width || e.height)
                            return [Manipulator[t](s).top + n, i];
                    }
                    return null;
                })
                .filter((e) => e)
    ...
    _getConfig(e) {
        if (
            ...
            let { id: t } = e.target;
            t || ((t = getUID(NAME$2)), (e.target.id = t)),
                (e.target = "#" + t);
        }
        ...
        n.classList.contains("dropdown-item")
            ...
            : (n.classList.add("active"),
              SelectorEngine.parents(n, ".nav, .list-group").forEach((e) => {
                  SelectorEngine.prev(e, ".nav-link, .list-group-item").forEach(
...
class Tab extends BaseComponent {
    ...
    show() {
        ...
        const i = e
            ? EventHandler.trigger(e, EVENT_HIDE$1, {
